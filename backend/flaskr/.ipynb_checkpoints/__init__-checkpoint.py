...
def create_app(test_config=None):
    ...
    def retrieve_questions():
        ...
        current_category= Category.query.filter(Question.category==Category.id).first()
   ...
   # @app.route("/api/v1.0/quizzes", methods=['POST'])
    ...
    def retrieve_quizz():
        ...
        current_quizz_question = Question.query.order_by(func.random()).first()
        ...
        try:
            ...
            if len(questions) > 0:
                ...
                return jsonify(
                        {
                        "success": True,
                        "question": current_quizz_question.format()
                        }
                    )
        except:
            abort(422)
    ...
    def internal_request_request(error):
        return (
